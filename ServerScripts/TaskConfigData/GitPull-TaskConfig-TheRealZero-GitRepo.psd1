...
@{
    TaskAction  = @{
        Execute                         = 'powershell' 
        Argument                        = '-WindowStyle Hidden -File "C:\GitHub\PSConfigasCodeFramework\ServerScripts\Git-TheRealZero-GitRepo-Repo.ps1"'
        #Id                              = '1'
    ...
    TaskName    = 'Github - Pull TheRealZero GitRepo'
    TaskPath    = "\Github Core\"
    Description = "Clones the GitRepo Repo from TheRealZero"
