...
@{
    TaskAction  = @{
        ...
        Argument                        = "-WindowStyle Hidden -Command `"Unregister-ScheduledTask -TaskName TestTaskUpdated -Confirm:`$false`""
        #Id                              = '1'
    ...
    PrincipalSecretName                 = 'Administrator'
    ...
    TaskName    = 'TestTask'
    TaskPath    = "\Automation\"
    Description = "TestTask created by Pester Tests for Update-PSCServerScheduledTask"
