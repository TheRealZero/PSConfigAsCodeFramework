...
@{
    TaskAction  = @{
        ...
        Argument                        = "-WindowStyle Hidden -Command `"Unregister-ScheduledTask -TaskName TestTask -Confirm:`$false`""
        #Id                              = '1'
    ...
    TaskSettingSet = @{
        ...
        DontStopIfGoingOnBatteries          = $true            #<bool>
        DontStopOnIdleEnd                   = $true            #<bool>
    ...
    TaskName    = 'TestTask'
    TaskPath    = "\Automation\"
    Description = "TestTask created by Pester Tests for New-PSCServerScheduledTask"
...
<#
    ...
    Available options for Action:
        ...
        -Argument (example: '-WindowStyle hidden -file "C:\Scripts\Git-AndroidISDAutomation-Repo.ps1')
