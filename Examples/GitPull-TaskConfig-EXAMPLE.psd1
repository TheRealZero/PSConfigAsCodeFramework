...
@{
    ...
    TaskAction          = @{
        Execute  = 'powershell' 
        Argument = '-WindowStyle Hidden -File C:\AutomationServer\ServerScripts\Git-REPONAME-Repo.ps1'
        #Id                              = '1'
...
<#
    ...
    Description = "Clones the REPONAME Repo"
        ...
        Argument = '-WindowStyle Hidden -File D:\GitHub\AutomationServer\ServerScripts\Git-REPONAME-Repo.ps1'
        #Id                              = '1'
        #WorkingDirectory                = 'D:\Manual Scripts'
    }
