...
#! NOTE: While very similar to the TCF for a Git Pull script, this example is for a TCF that will run an automation in your 
#! project code repository.  This file would be placed in your project code repository, not in the PSConfigAsCodeFramework repository.

@{
    TaskName            = 'ScriptName - REPONAME'
    TaskPath            = "\Automation\"
    Description         = "Description of the task"
    
    TaskAction          = @{
        Execute  = 'powershell' 
        Argument = '-WindowStyle Hidden -File D:\GitHub\REPONAME\ScriptName.ps1'
        #Id                              = '1'
    ...
    PrincipalSecretName = 'NAMEOFSECRETINVAULT'
...
<#
    .EXAMPLE
        ...
        @{
            TaskAction  = @{
                Execute                         = 'powershell' 
                Argument                        = '-WindowStyle Hidden -File "C:\Scripts\Git-AndroidAutomation-Repo.ps1'
            }
            ...
            TaskName    = 'Github - Pull AndroidAutomation'
            TaskPath    = "\Github Core\"
            Description = "Clones the AndroidAutomation Repo"
    ...
    Available options for Action:
        ...
        -Argument (example: '-WindowStyle hidden -file "C:\Scripts\Git-AndroidAutomation-Repo.ps1')
        -WorkingDirectory (example: 'C:\Scripts')
        -Id <string>
